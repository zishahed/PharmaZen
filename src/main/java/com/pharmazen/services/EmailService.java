...
public class EmailService {
    ...
    public static void sendOtp(String toEmail, String name, String otpCode) {
        final String from = "put your personal email address as Firebase don't generate custom emails from there no-reply";
        final String password = "put the password gotten from 'myaccount.google.com/apppasswords'";
